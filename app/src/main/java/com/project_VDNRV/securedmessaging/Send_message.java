            ...
            public void onClick(View v) {
               ...
               final FirebaseDatabase database = FirebaseDatabase.getInstance();
                ...
                codename.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    String reciever = user.getText().toString().toLowerCase().trim();
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if(reciever.isEmpty() || !dataSnapshot.hasChild(reciever))
                        {
                            ...
                            else if(mess.length()>60)
                            {
                                ...
                                if(l==1&&l<=3 && (que1.isEmpty() || ans1.isEmpty()))
                                {
                                    if(security_quetion1.getText().toString().isEmpty())
                                    {
                                        security_quetion1.requestFocus();
                                ...
                                if(l==2&&l<=3&&( que2.isEmpty() || ans2.isEmpty()))
                                {
                                    if(security_quetion2.getText().toString().isEmpty())
                                    {
                                        security_quetion2.requestFocus();
                                ...
                                if(l==3 && (que3.isEmpty() || ans3.isEmpty()))
                                {
                                    if(security_quetion3.getText().toString().isEmpty())
                                    {
                                        security_quetion3.requestFocus();
                                        security_quetion3.setError("It cannot be empty");
                                    }
                                    if(security_answer3.getText().toString().isEmpty())
                                    {
                                        security_answer3.requestFocus();
                                        security_answer3.setError("It cannot be empty");
                                    }
                                }
